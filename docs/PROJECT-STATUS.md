...
## 4. What is verified, and what is still illustrative
...
### 6.3 Media and social mention monitoring
...
### 6.7 Bulk upload and live calculation
...
## 7. Decisions and inputs needed from Seplat

Progress on several items is now blocked on Seplat rather than on development.
